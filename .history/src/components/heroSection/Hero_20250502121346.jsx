      ...
      <div className="hero-content">
        ...
        <p>
          {currentSlide === 1 || currentSlide === 2
            ? "We are Google's Featured, World's Top Solution Provider! Clients in 19 countries! The first client from a new country will get 20% OFF on their first project."
