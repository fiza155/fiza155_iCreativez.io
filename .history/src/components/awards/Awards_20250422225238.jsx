...
import "./Awards.css";
import google from "../../assets/images/Awards/google";
import goodFirm from "../../assets/images/Awards/googlepartner.png";
import topweb from "../../assets/images/Awards/topweb.png";
      ...
      <div className="custom">
        ...
        <div className="row justify-content-center align-items-center awards-layout">
          ...
          <div className="col-6 col-md-2 text-center small-card">
            <img src={B2b} alt="Top Asia" className="img-fluid" />
          </div>

          {/* Image - Center Left */}
          <div className="col-6 col-md-2 text-center large-card">
            <img src={GP} alt="Google Partner" className="img-fluid" />
          </div>

          {/* Image - Center Right */}
          <div className="col-6 col-md-2 text-center large-card">
            <img src={topweb} alt="Good Firms" className="img-fluid" />
          </div>
