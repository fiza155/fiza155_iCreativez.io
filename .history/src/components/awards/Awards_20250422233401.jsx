    ...
    <div className="awards-wrapper">
      <div className="custom">
        ...
        <div className="row justify-content-center align-items-center awards-layout">
          {/* Image - Left */}
          <div className="col-6 col-md-2 text-center small-card mx-">
            <img src={toppak} alt="Top Asia" className="img-fluid" />
          </div>

          {/* Image - Center Left */}
          <div
            className="col-6 col-md-2 text-center mx-2"
            style={{ height: "auto" }}
          >
          ...
          {/* Image - Center Right */}
          <div
            className="col-6 col-md-2 text-center large-card mx-2"
          ...
          {/* Image - Right */}
          <div className="col-6 col-md-2 text-center small-card mx-2">
            <img src={toppak} alt="Top Asia" className="img-fluid" />
          </div>
        </div>
      </div>
