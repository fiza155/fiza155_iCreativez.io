...
const OurServices = () => {
  ...
  return (
    <div className={`services-section ${showMore ? "expanded" : ""}`}>
      <div className="text-start ps-lg-5 ms-lg-4 text-md-center">
        <h5 className="text-uppercase red-heading ">Our Services</h5>
        <h2 className="fw-bold mb-5 text-dark">Transform Your Ideas</h2>
      </div>
