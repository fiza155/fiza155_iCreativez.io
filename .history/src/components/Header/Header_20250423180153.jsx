      ...
      <div className="container-fluid px-5 d-flex justify-content-center align-items-center">
        ...
        >
          <ul className="navbar-nav">
            ...
            <li className="nav-item">
              <CustomButton
                className="py-2 px-3 gap-5 fw-normal d-flex justify-content-center align-items-center"
            ...
            <li className="nav-item">
              <CustomButton
                className="py-2 px-3 fw-normal gap-4 d-flex justify-content-center align-items-center primary-btn--outline"
                style={{ fontSize: "13.5px" }}
              >
                Let's Talk Business
              </CustomButton>
