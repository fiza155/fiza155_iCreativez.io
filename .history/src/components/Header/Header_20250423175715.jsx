...
const Header = () => {
  return (
    <nav className="navbar navbar-expand-lg navbar-expand-md bg-white px-5 d-flex justify-content-center align-items-center">
      <div className="container-fluid px-5">
        ...
        >
          <ul className="navbar-nav">
            ...
            <li className="nav-item">
              <CustomButton
                className="py-2 px-3 fw-normal d-flex justify-content-center align-items-center primary-btn--outline"
                style={{ fontSize: "13.5px" }}
              >
                Let's Talk Business
              </CustomButton>
