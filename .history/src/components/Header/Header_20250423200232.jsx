    ...
    <nav className="navbar navbar-expand-lg bg-white">
      <div className="container-fluid px-4">
        ...
        <a className="navbar-brand" href="#">
          <img src={LogoGif} alt="Logo" className="img-fluid logo ps-lg-4" />
        </a>
        ...
        >
          <ul className="navbar-nav ms-auto align-items-center gap-2">
            ...
            <li className="nav-item">
              <span className="header-nav text-decoration-none text-dark">
                24/7 Service Email:{" "}
                <a href="mailto:client.contact@icreativez.com">
                  <span className="fw-bold">client.contact@icreativez.com</span>
                </a>
              </span>
            </li>
            <li className="nav-item">
