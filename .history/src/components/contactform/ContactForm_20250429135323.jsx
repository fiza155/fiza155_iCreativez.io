      ...
      <div className="row g-5">
          ...
          <form onSubmit={handleSubmit}>
            <div className="row">
              <div className="col-md-6 mb-3">
                ...
                <input type="text" className="form-control small" required />
              </div>
              <div className="col-md-6 mb-3">
                <label className="form-label">
            ...
            <button type="submit" className=" btn-submit  w-25 small">
              Submit
            </button>
          </form>
        </div>
        ...
        <div className="col-lg-6 d-flex flex-column justify-content-center">
          ...
          <div className="info-section text-start">
            <div className="">
              <i className="bi bi-people-fill form-heading icon"></i>
            </div>
            <h3 className="form-heading">Global Leaders</h3>
            <p className="">
