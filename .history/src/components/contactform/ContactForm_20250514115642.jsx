      ...
      <div className="row g-5">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
              ...
              <select className="form-select" required>
                ...
                <option value="Western Europe">Rest of World</option>
              </select>
            </div>
            <div className="mb-3">
              <label className="form-label">
                City/Country<span className="text-danger">*</span>
              </label>
              <input
                type="text"
                className="form-control"
        ...
        <div className="col-lg-6 d-flex flex-column justify-content-center">
          <div className="info-section text-start mb-5">
            ...
            <p className="">
              We have 5 offices across the globe, serving clients with localized
          ...
          <div className="info-section text-start">
            <div className="">
              <i className="bi bi-lightning-charge icon-wrapper icon"></i>
            </div>
            <h3 className="form-heading">Cutting-edge Solutions</h3>
            <p className="">
              Delivering future-ready technology to empower your business for
              what's next.
            </p>
            <CustomButton className="mt-3 px-4 py-3">Learn more</CustomButton>
          </div>
