...
const FeaturedInsights = () => {
  ...
  return (
    <div className="featured-insights  bg-white" ref={ref}>
      <div className="row">
        <div className="col-md-5 flex-column justify-content-center ps-5 custom">
          ...
          <h3 className="fw-normal text-dark m">Turning Ideas Into Action</h3>
          <CustomButton className="position-relative my-3 ">
            Explore More
          </CustomButton>
        </div>

        <div className="col-md-7 overflow-auto" style={{ maxHeight: "600px" }}>
