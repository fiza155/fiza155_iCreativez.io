...
const FeaturedInsights = () => {
  ...
  return (
    <div className="featured-insights   " ref={sectionRef}>
      <div className="row ">
        <div className="col-md-5 flex-column justify-content-center  ">
          <h4 className="text-start text-uppercase red-heading">
            Featured Insights
          </h4>
          <h2>
        ...
        <div className="col-md-7 overflow-visible ">
          ...
          <div className="d-none d-md-flex gap-3  flex-wrap ">
            {(() => {
              const layout = [2, 3, 3];
              let cardIndex = 0;
          ...
          {/* Layout for small/medium screens */}
          <div className="d-md-none row row-cols-2 row-cols-sm-2 row-cols-md-3 g-3">
